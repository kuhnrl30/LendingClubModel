...
The number of loans issued has grown significantly since 2007.  In fact the growth rate in the first 2 years was `r round(CAGR(42535,188181,2),2)*100`%. Growth has leveled off since 2015 to only `r round(434407/421095,2)*100-100`%. The CAGR from 2007 to 2016 is `r round(CAGR(603,434401,10),2)*100`%.
