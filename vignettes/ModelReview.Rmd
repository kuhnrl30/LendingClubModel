...
- LinkedIn profile shows work experience as a quant for UBS in structuring CDOs.  
...
Model Review: A very comprehensive analysis with several persepctives that can be reused and updated. Use of violin charts to show the distribution of credit scores was very effective however plotly charts were less so from a technology perspective.  Having just read Tufte's work, I think the bubble charts were too large to convey so little information. The pie charts also weren't effective because the default rates by category were embedded in the pop-ups instead of being directly visualized. 
